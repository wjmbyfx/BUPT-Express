...
### 名称:getUserCommentForCurrentOrder 获得当前订单的用户评价
...
### 名称:getPostmanCommentForCurrentOrder 获得当前订单的用户评价
...
参数名:score:评分 openid 派送员的openid
